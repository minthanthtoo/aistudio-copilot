...
# Do the same for other inputs that might have this issue or need blur updates
# Actually name, desc, features don't have 'change', let's add 'change' with timeout to them too!
