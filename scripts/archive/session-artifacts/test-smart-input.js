...
proxyState.ui = { draft: "", buildView: "input", specAnswers: {}, splitStrategy: "stage", settings: { activeTab: "build" } };
...
const actionArea = ui.querySelector(".aisq-actions");
console.log("Buttons before typing:", actionArea.innerHTML);

// Simulate typing
textarea.value = "I want a simple React app";
textarea.dispatchEvent(new dom.window.Event("input"));

console.log("Buttons after typing:", actionArea.innerHTML);
