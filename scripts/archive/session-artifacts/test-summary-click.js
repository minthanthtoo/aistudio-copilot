...
proxyState.ui = { draft: "", buildView: "input", specAnswers: {}, splitStrategy: "auto", settings: { activeTab: "build" }, showAdvanced: false };
...
let ui = ctx.renderBuild();
const summary = ui.querySelector("summary");
console.log("Before click, showAdvanced:", ctx.state.ui.showAdvanced);
summary.dispatchEvent(new dom.window.MouseEvent('click'));
console.log("After click, showAdvanced:", ctx.state.ui.showAdvanced);
ui = ctx.renderBuild(); // Re-render with showAdvanced = true
console.log("Re-rendered successfully without throwing!");
